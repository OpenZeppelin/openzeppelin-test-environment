...
Test Environment requires your contracts to be compiled: you can use https://www.trufflesuite.com/docs/truffle/getting-started/compiling-contracts[*Truffle*] to do this.
